...
echo "  Double-click GLM-OCR-Desktop.command to launch."
echo "  (If macOS shows \"cannot verify the developer\" on first launch,"
echo "   right-click the file in Finder and choose \"Open\" instead.)"
echo ""
echo "  (To launch manually from Terminal)"
