...
echo "  Doppelklicken Sie auf GLM-OCR-Desktop.command, um zu starten."
echo "  (Falls macOS beim ersten Start \"Entwickler kann nicht verifiziert werden\""
echo "   anzeigt, klicken Sie im Finder mit der rechten Maustaste auf die Datei"
echo "   und wählen Sie \"Öffnen\".)"
echo ""
echo "  (Manueller Start über das Terminal)"
